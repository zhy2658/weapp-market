...
<el-select v-model="status"  @change="selectPlatform"  >
  <el-option  v-for="(item,index) in statusOption" :key="index" :value='index' :label='item'>{{index}}_{{item}}</el-option>
</el-select>
  ...
  <Dialog v-model="dialogVisible"  @initOrdereList="initOrdereList"  :id="id" :currentRow="currentRow" :dialogTitle="dialogTitle" />
</template>
